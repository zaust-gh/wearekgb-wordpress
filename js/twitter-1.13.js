...
if (typeof renderTwitters != 'function') (function () {
    ...
    window.renderTwitters = function (obj, options) {
        ...
        //create node with id
        function nodeWithId(e) {
            var x = document.createElement(e);
            x.setAttribute('id', 'tweets');
            return x;
        }
        ...
        var data = null;
        var ul = nodeWithId('ul'), li, statusSpan, timeSpan, i, max = obj.length > options.count ? options.count : obj.length;
        ...
        // initialise carousel from carouFredSel.js
        $(function() {
			$('ul#tweets').carouFredSel({
				circular	: true,
				direction	: "up",
				items		: 1,
				scroll		: {
